# -*- coding: utf-8 -*-
"""audio_video_ViT_crossed.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RDgDT9_vwNGTDhFXhzA4N-3rWgGfbeMC
"""
...
def cross_test_ViT(_modality_model, _modality_features):
      ...
      state_dict = torch.load('/content/drive/MyDrive/csci535/models/ViT_' + _modality_model + '_50_16_0.0001')
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python3 audio_video_vit.py video_folder spectrogram_folder")
        sys.exit(1)
