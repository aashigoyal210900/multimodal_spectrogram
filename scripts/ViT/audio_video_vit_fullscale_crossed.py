# -*- coding: utf-8 -*-
"""audio_video_ViT_fullscale_crossed.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/139vTc6Vo86gimXMa2JZ-vb7gzH63fkKU
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        print("Usage: python3 audio_video_vit.py path/to/X.npy path/to/y.npy path/to/X_spec.npy, path/to/y_spec.npy")
        sys.exit(1)

    input_X = sys.argv[1]
    input_y = sys.argv[2]
    input_X_spec = sys.argv[3]
    input_y_spec = sys.argv[4]
    ...
    if not os.path.exists(input_y):
        print("input_y")
        sys.exit(1)
    if not os.path.exists(input_X_spec):
        print("input_X_spec")
        sys.exit(1)
    if not os.path.exists(input_y_spec):
        print("input_y_spec")
        sys.exit(1)
    ...
    X_spec = np.load(input_X_spec, mmap_mode='r')
    y_spec = np.load(input_y_spec, mmap_mode='r')
