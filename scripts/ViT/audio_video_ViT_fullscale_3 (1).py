...
get_ipython().system("cp 'ViT_audio_video_fullscale_50_32_0.0001' 'models'")
get_ipython().system("cp 'ViT_audio_fullscale_50_32_0.0001' 'models'")
get_ipython().system("cp 'ViT_video_fullscale_50_32_0.0001' 'models'")
