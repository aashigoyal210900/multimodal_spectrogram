...
def cross_test_ViT(_modality_model, _modality_features):
  ...
  state_dict = torch.load('/Users/aashigoyal/Desktop/vscode/aashimain/csci535/final_temp/models/ViT_' + _modality_model + '_fullscale_50_32_0.01',map_location=torch.device('cpu'))
